...
export default function MaterialItem2({material}) {
    let name = material.nameMat;
    let id = material.idMat;
    ...
    return (
        <>
            {isVisible && (
                <li id={material.idMat} title='Material record' key={material.idMat} className='flex flex-col'>

                    <div className='grid grid-cols-4 bg-gray-100 px-4 py-2 text-sm'>
                        <div className='col-start-1 col-end-1'>{name}</div>
                        <div className='text-gray-700 col-start-2 col-span-2'>{material.idMat}</div>
                        <div className='flex flex-row gap-4 justify-between col-start-4 col-end-4'>
                            <ToolsGroup item={material} type={'material'} onRemoveFunc={setVisibility}></ToolsGroup>
                    ...
                    <div className='flex flex-col px-4 py-2 collapse'>
                        <div className='grid grid-cols-2 border-b-[1px]'>
                            ...
                            <div className='col-start-2 col-end-2'>{material.idMat}</div>
                        </div>
                        <div className='grid grid-cols-2 border-b-[1px]'>
                            <p className='col-start-1 col-end-1'>Name:</p>
                            <div className='col-start-2 col-end-2'>{material.nameMat}</div>
                        </div>
                        <div className='grid grid-cols-2 border-b-[1px]'>
                            <p className='col-start-1 col-end-1'>Description:</p>
                            <div className='col-start-2 col-end-2'>{material.descMat}</div>
                        </div>
                        <div className='grid grid-cols-2 border-b-[1px]'>
                            <p className='col-start-1 col-end-1'>Unit:</p>
                            <div className='col-start-2 col-end-2'>{material.unitMat}</div>
                        </div>
                    </div>
